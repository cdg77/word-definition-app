...
describe(Word) do
  ...
  describe('#type') do
    it('returns the type of word') do
      test_word = Word.new({:word => 'definition', :type => 'noun', :syllable => 'def i ni tion'})
  ...
  describe('.clear') do
    it('clears the array of all entries') do
      test_word = Word.new({:word => 'definition', :type => 'noun', :syllable => 'def i ni tion'}).save()
      Word.clear()
      expect(Word.all()).to(eq([]))
    end
  end
  ...
  describe('.find') do
    it('finds a word by id') do
      test_word = Word.new({:word => 'definition', :type => 'noun', :syllable => 'def i ni tion'})
      test_word.save()
      test_word2 = Word.new({:word => 'quaggy', :type => 'adjective', :syllable => 'quag·gy'})
      test_word2.save()
